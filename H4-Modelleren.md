...
Het document Metamodel voor informatiemodellen, opgesteld door VNG Realisatie, Kadaster en Geonovum wordt overgenomen voor toepassing binnen het DSO. Het genoemde metamodel wordt aangeduid als metamodel MIM.
...
Het MIM onderscheidt een aantal niveaus van informatiemodellering: van begrippenmodel, via conceptueel en logisch informatiemodel tot technisch gegevensmodel. Voor het metamodel in deze handreiking is het niveau van het logisch informatiemodel van toepassing. Ter begrip hiervan is in de volgende paragrafen uitleg uit MIM overgenomen.
...
Het metamodel MIM benoemt op enkele punten alternatieve oplossingen. Voor toepassing binnen het DSO wordt een keuze gemaakt uit deze alternatieven. 

Relatiesoort of relatierol.

MIM heeft twee alternatieven voor de modellering en metadatering van relaties tussen objecttype. Een relatie wordt gerealiseerd door een ‘relatiesoort’. 
...
**Naamgevingconventies:**
 ...
 1. UML-talen mogen geen spaties bevatten.
 1. UML-talen geven een precieze en begrijpelijke technische beschrijving voor klassen, attributen, operaties en parameters. 
 1. Combineer indien nodig verschillende woorden om precieze en begrijpelijke namen te vormen zonder tussenliggende karakters (“\_”, “-”, of spatie). 
 1. Maak van de beginletter van ieder deelwoord van namen van attributen, waarden in een lijst, operaties, rollen van associaties en parameters een hoofdletter, behalve de beginletter van het eerste woord. Bij namen van klassen, packages, typespecificaties en associaties wordt ook de beginletter een hoofdletter. 
 1. Houd namen zo kort als praktisch mogelijk. Gebruik standaard afkortingen als ze begrijpbaar zijn, gebruik geen voorzetsels en laat werkwoorden vallen wanneer ze niet significant bijdragen aan de betekenis. 
 1. Afgezien van sleutelwoorden die uit internationale normen komen is de voertaal bij voorkeur Nederlands.
